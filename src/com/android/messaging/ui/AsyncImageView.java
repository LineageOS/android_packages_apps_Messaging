...
import com.cyanogenmod.messaging.cache.AsyncImageViewWebImageCache.LookupProviderAvatarImageCacheCallback;
...
public class AsyncImageView extends ImageView implements
    ...
    public void setImageUrl(String url) {
        ...
        if (mUrl != null && !mUrl.equals(url)) {
            mDownloadImageTask.cancel();
        }
        mUrl = url;
        AsyncImageViewWebImageCache.fetchBitmap(mUrl, this);
    }
    ...
    private class DownloadImageTask extends AsyncTask<Void, Void, Bitmap> {
        ...
        protected void onPostExecute(Bitmap bitmap) {
            ...
            AsyncImageViewWebImageCache.addBitmap(this.mUrl, bitmap);
    ...
    public void onImageFound(String key, Bitmap bitmap) {
        if (bitmap == null && !TextUtils.isEmpty(key)) {
            ...
            mDownloadImageTask = new DownloadImageTask(key, this);
