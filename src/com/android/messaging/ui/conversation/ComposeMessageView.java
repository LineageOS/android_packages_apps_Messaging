...
public class ComposeMessageView extends LinearLayout
    ...
    public ComposeMessageView(final Context context, final AttributeSet attrs) {
        ...
        String unicodeNonEncodableValue = context.getString(R.string.unicode_stripping_non_encodable_value);
        String unicodePrefKey = context.getString(R.string.unicode_stripping_pref_key);
        SharedPreferences prefs = context.getSharedPreferences(BuglePrefs.SHARED_PREFERENCES_NAME, Context.MODE_PRIVATE);
