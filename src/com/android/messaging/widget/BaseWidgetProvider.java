...
public abstract class BaseWidgetProvider extends AppWidgetProvider {
    ...
    public static boolean isWidgetSupported(Context context) {
        if (!BaseWidgetProvider.sWidgetChecked) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR2) {
                BaseWidgetProvider.sWidgetSupported = hasAppWidgetsSystemFeature(context);
            } else {
                ...
                BaseWidgetProvider.sWidgetSupported = true;
            }
            BaseWidgetProvider.sWidgetChecked = true;
        }

        return BaseWidgetProvider.sWidgetSupported;
    }
