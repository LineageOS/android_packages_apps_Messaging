...
public class AllContactsCursorBuilder {
    /**
     * Attempt to build the cursor records from the all contacts cursor if it's ready to be consumed.
    ...
    public static Cursor build(final Cursor allContactsCursor) {
        if (allContactsCursor != null) {
            ...
            while (allContactsCursor.moveToNext()) {
                ...
                row[ContactUtil.INDEX_SORT_KEY] = allContactsCursor.getString(ContactUtil.INDEX_SORT_KEY);
