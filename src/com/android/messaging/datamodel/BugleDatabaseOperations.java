...
public class BugleDatabaseOperations {
    ...
    public static boolean deleteConversationByProtocol(final DatabaseWrapper dbWrapper,
                                                       final String conversationId,
                                                       final long cutoffTimestamp, final int protocol) {

        if(protocol != MessageData.PROTOCOL_SMS && protocol != MessageData.PROTOCOL_MMS) {
            return deleteConversation(dbWrapper, conversationId, cutoffTimestamp);
        }
        ...
        try {
            ...
            dbWrapper.delete(DatabaseHelper.MESSAGES_TABLE,
                    ...
                    new String[] { conversationId, Long.toString(cutoffTimestamp), Integer.toString(protocol) });
    ...
    public static long getCutOffTimeStampFromLimit(final String conversationId, final int maxLimit, final int protocol) {
