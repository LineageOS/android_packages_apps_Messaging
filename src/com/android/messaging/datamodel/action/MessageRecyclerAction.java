...
public class MessageRecyclerAction extends Action implements Parcelable {
    ...
    public static void deleteMessages(final String conversationId, final int protocol, final long cutOffTimeStamp) {
        final MessageRecyclerAction action = new MessageRecyclerAction(conversationId, protocol, cutOffTimeStamp);
        action.start();
    }
    ...
    private MessageRecyclerAction(final String conversationId, final int protocol, final long cutOffTimeStamp) {
        super();
