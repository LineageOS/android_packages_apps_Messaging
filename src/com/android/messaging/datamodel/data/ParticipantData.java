...
public class ParticipantData implements Parcelable {
     ...
     * @param phoneNumber The raw phone number
     * @return instance
     * @ formattedNumber if the number is regex value from BlackList db , then it will update with non normalized number
     * in display_destination column
     */
    public static ParticipantData getFromRawPhoneBySystemLocale(final String phoneNumber, final String formattedNumber) {
