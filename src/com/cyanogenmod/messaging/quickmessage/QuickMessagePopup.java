...
public class QuickMessagePopup extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Get the preferences
        String unicodeIntactValue = getString(R.string.unicode_stripping_leave_intact_value);
        String unicodePrefKey = getString(R.string.unicode_stripping_pref_key);
        SharedPreferences prefs = getSharedPreferences(BuglePrefs.SHARED_PREFERENCES_NAME,
        ...
        if (!unicodeIntactValue.equals(unicodeStripping)) {
            String unicodeNonEncodableValue = getString(
        ...
        mCloseClosesAll = prefs.getBoolean(PrefsUtils.QM_CLOSE_ALL_ENABLED, false);
        mWakeAndUnlock = prefs.getBoolean(PrefsUtils.QM_LOCKSCREEN_ENABLED, false);
